  ...
  const services = [
    {
      ...
      desc: 'Intuitive, user-centric interfaces that guide visitors to conversion through psychological triggers and clear visual hierarchy.',
      impact: 'Reduces bounce rates and increases time-on-site by creating frictionless user journeys that resonate with your target audience.',
    },
    {
      id: 'development',
      title: 'Website Development',
      icon: <Settings className="w-8 h-8" />,
      desc: 'Clean, scalable code built on modern tech stacks for maximum reliability and future-proof digital infrastructure.',
      impact: 'Ensures your site is fast, secure, and easily maintainable as your business scales and evolves in a competitive market.',
    },
    {
      id: 'ecommerce',
      title: 'Ecommerce Development',
      icon: <ShoppingCart className="w-8 h-8" />,
      desc: 'High-performance storefronts optimized for average order value, checkout speed, and seamless inventory management.',
      impact: 'Directly impacts bottom-line revenue by removing friction from the buying process and enhancing the customer shopping experience.',
    },
    {
      id: 'redesign',
